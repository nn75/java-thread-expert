...
/**
 * Barrier coordinates the work to guarantee that some portion of the work is done by all threads
 * before the rest of the work is performed
 */
public class BarrierDemo {
    ...
    public static class Barrier {
        ...
        public void waitForOthers() throws InterruptedException {
            ...
            if (isLastWorker) {
                semaphore.release(numberOfWorkers - 1);  // 前面的线程都已经阻塞在 acquire()，等着最后一个线程释放许可证
            } else {
                semaphore.acquire();
            }
        }
